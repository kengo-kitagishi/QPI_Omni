...
Driver for the 260906 grid session.

  raw     C:\260906\grid_YE_0p05_1   Pos0..Pos35 (4356 points)
  output  D:\AquisitionData\Kitagishi\260906\grid_YE_0p05_1
...
Run:
    python watch_grid_then_recon_260906.py
    python watch_grid_then_recon_260906.py --dry-run    # patch + report only
    python watch_grid_then_recon_260906.py --skip-wait  # acquisition already done
"""
import argparse
import re
import shutil
...
WATCH_DIR = Path(r"C:\260906\grid_YE_0p05_1")
...
BATCHES = [
    {
        ...
        "pos_list": WATCH_POS,
        "delete_raw": True,                      # frees C: (~625 GB) after verification
    },
]
...
def main():
    ...
    log("=" * 70)
    log(f"watch_grid_then_recon_260906  (POS_SPLIT={POS_SPLIT}, Z_INDEX={Z_INDEX})")
    log("=" * 70)
