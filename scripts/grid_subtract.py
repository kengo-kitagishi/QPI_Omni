...
TIMELAPSE_DIR = r"E:\Acuisition\kitagishi\260301\movetest_8\Pos4"

# pos_shifts.json と channel_rois.json の場所
SHIFTS_JSON       = r"E:\Acuisition\kitagishi\260301\movetest_8\Pos4\output_phase\channels\pos_shifts.json"
CHANNEL_ROIS_JSON = r"E:\Acuisition\kitagishi\260301\movetest_8\Pos4\output_phase\channels\channel_rois.json"
...
def main():
    ...
    for t in tqdm(range(n_frames), desc="フレーム処理"):
        ...
        for ch in range(n_channels):
            ...
            tl_crop = extract_rect_roi(tl_warped, crop_cy, crop_cx, crop_w, crop_h)

            if grid_img is not None:
                grid_crop = extract_rect_roi(grid_img, crop_cy, crop_cx, crop_w, crop_h)
