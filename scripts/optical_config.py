...
OFFAXIS_CENTER = (463, 1672)   # (row, col) -- updated 2026-09-16 (crop 400:2448 right channel)
...
OFFAXIS_HISTORY = [
    {"date": "2026-09-16", "center": (463,  1672), "note": "re-measured during vis_1 acquisition (basler_image_seq vis_1/Pos0), same peak on frames 0/40/77, upper-half +1 order (crop 400:2448)"},
