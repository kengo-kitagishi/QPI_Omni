"""
watch_grid_then_recon_260917.py

Driver for the 260917 grid session.

  raw     E:\260917\grid_hologram_0p05_1          (Pos0..Pos40, 41 Pos)
  output  D:\AquisitionData\Kitagishi\260917\grid_hologram_0p05_1
...
The raw on E: is kept (never deleted by this script).

Completion: every point of Pos0..LAST_POS holds images and nothing new has
been written for IDLE_MINUTES.

Run:
    python watch_grid_then_recon_260917.py
    python watch_grid_then_recon_260917.py --dry-run    # patch + report only
    python watch_grid_then_recon_260917.py --skip-wait  # acquisition already done
"""
import argparse
import re
import shutil
...
WATCH_DIR = Path(r"E:\260917\grid_hologram_0p05_1")
OUTPUT_DIR = Path(r"D:\AquisitionData\Kitagishi\260917\grid_hologram_0p05_1")
...
LAST_POS      = 40      # this acquisition covers Pos0..Pos40
...
MIN_FREE_GB_OUT = 150   # recon output ~2.7 GB/Pos -> ~112 GB for 41 Pos
...
def main():
    ...
    log("=" * 70)
    log(f"watch_grid_then_recon_260917  (POS_SPLIT={POS_SPLIT}, Z_INDEX={Z_INDEX})")
    log("=" * 70)
